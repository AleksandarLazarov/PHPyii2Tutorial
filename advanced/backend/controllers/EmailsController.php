...
use yii\web\UploadedFile;   //Добавяме за да можем да ъплолдваме файлове
...
class EmailsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) { //от тук махаме $model->save() и го слагаме долу
            ...
            if ($model->attachment)
            {
                $value = Yii::$app->mailer->compose()
                    ->setFrom('aplazarov000@gmail.com')
//                    ->setFrom(['aplazarov000@gmail.com' => 'DoingITeasyChannel'])
