...
use yii\helpers\Json;   //Позволява използването на JSON
...
class LocationsController extends Controller
{
    ...
    public function actionGetCityProvince($zipId){      //Това е метод който използва Json за автоматично попълване на полетата
