...
<div class="companies-form">
    ...
    <?php $form = ActiveForm::begin(['enableAjaxValidation'=>true]); ?> <!--Добавяне на валидация Ajax-->
    ...
    <?= $form->field($model, 'company_start_date')->widget(     //Това прави поле за дати
        ...
        'clientOptions' => [
            'autoclose' => true,
            'format' => 'yyyy-mm-dd'        //формата трябва да е като в ДБ-то
        ]
    ]);?>
